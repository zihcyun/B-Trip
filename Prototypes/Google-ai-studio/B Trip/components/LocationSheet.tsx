...
const LocationSheet: React.FC<LocationSheetProps> = ({ location, onClose }) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-50 animate-slide-up">
      ...
      <div className="bg-white rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.12)] p-6 pb-10">
        <div className="w-12 h-1.5 bg-gray-200 rounded-full mx-auto mb-6" />

        {/* Header Actions */}
        <div className="flex items-start justify-between mb-2">
          <h2 className="text-xl font-bold text-black">{location.name}</h2>
        ...
        {showTripSelect && (
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-full mb-8 bg-white border rounded-xl shadow-xl p-4 w-[80%] z-20">
            <p className="text-xs font-medium text-gray-400 mb-2">我的行程</p>
              ...
              <div className="flex-1 px-3 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-400 truncate w-32">彰化縣文林北路38巷7號9弄</p>
                  </div>
                </div>
              ...
              <div className="flex-1 px-3 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-gray-400 truncate w-32">彰化縣中山路78巷1號</p>
                  </div>
                </div>
                <button className="p-2 text-gray-400 hover:text-red-500"><Trash2 size={18} /></button>
              </div>
